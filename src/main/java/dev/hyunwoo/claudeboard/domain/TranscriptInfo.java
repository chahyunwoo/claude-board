 ...
 *
 * <p>모든 필드가 null 일 수 있다. 역순 리더는 상한(기본 1MB)에 걸리면 <b>부분 결과를 반환</b>하기 때문이다 — 제목이 없어도 상태 판별은 되어야 한다.
 *
...
public record TranscriptInfo(
    ...
    public enum RecordKind {
         ...
         *
         * <p>실측(2026-09-03): 살아있는 세션 13개 중 2개가 이 형태였고 둘 다 실제로 작업 중이었다. 이걸 {@link #ASSISTANT} 와
    ...
    public static TranscriptInfo empty() {
        return new TranscriptInfo(
                null, null, null, null, null, null, null, null, RecordKind.NONE, false);
    }
}
